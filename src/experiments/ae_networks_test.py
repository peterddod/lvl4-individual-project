...
FILENAME = 'ae_network_test_results.csv'
...
def run_experiment(model, name, seed, params):
    print('\n===============================')
    ...
    results = f'{name},{params["subnets"]},{params["h_size"]},{seed},{acc},{train_end-train_start},{pred_end-pred_start}'
...
if __name__ == '__main__':
    ...
    RESULTS_HEADER = 'name,subnets,neurons,seed,acc,train_time,test_time'
    ...
    for name, model in models.items():
        ...
        for params in params_list:
            ...
            for seed in SEEDS:
                ...
                run_experiment(model_full, name, seed, in_params)
